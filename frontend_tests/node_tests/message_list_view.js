...
test("muted_message_vars", () => {
    ...
    (function test_hidden_message_variables() {
        ...
        assert.equal(result[1].contains_group_mention, true);
        assert.equal(result[1].contains_direct_user_mention, false);
        ...
        // Additionally test that, both mention properties are false even on that message which has a mention.
        assert.equal(result[1].contains_group_mention, false);
        assert.equal(result[1].contains_direct_user_mention, false);
